...
local OVERTIME_AND_BOMB_HEALS = bit.bor(OVERTIME_HEALS, BOMB_HEALS)

HealComm.ALL_HEALS, HealComm.CHANNEL_HEALS, HealComm.DIRECT_HEALS, HealComm.HOT_HEALS, HealComm.CASTED_HEALS, HealComm.ABSORB_SHIELDS, HealComm.ALL_DATA, HealComm.BOMB_HEALS, HealComm.OVERTIME_AND_BOMB_HEALS =
ALL_HEALS, CHANNEL_HEALS, DIRECT_HEALS, HOT_HEALS, CASTED_HEALS, ABSORB_SHIELDS, ALL_DATA, BOMB_HEALS,
	OVERTIME_AND_BOMB_HEALS
