...
SA.CheckFlags = true -- for everyone/true for only groups.
...
local function Update(self, event, unit, absorb)
	...
	* unit - the unit for which the update has been triggered (string)
	...
	local myIncomingHeal = ((HealComm:GetHealAmount(GUID, HealComm.ALL_HEALS, timeWindow, UnitGUID("player")) or 0) * (HealComm:GetHealModifier(GUID) or 1)) or
		0
	local allIncomingHeal = ((HealComm:GetHealAmount(GUID, HealComm.ALL_HEALS, timeWindow) or 0) * (HealComm:GetHealModifier(GUID) or 1)) or
		0
